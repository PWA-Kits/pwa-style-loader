...
(async () => {
  ...
  console.log(
    chalk.cyan.bold("\n🚀 pwa-kit-style-loader") +
      chalk.gray("\nby Abhisek Maiti") +
      chalk.gray("\nAdds vanilla CSS 🍦 support to Salesforce PWA Kit") +
  ...
  const BRAND = `
/**
 * Generated by pwa-kit-style-loader
...
`.trim();
  ...
  async function createOrReplace({ dest, template, filename }) {
    ...
    if (!replace) {
      console.log(chalk.gray(`ℹ️ Skipped ${filename}. No changes made.`));
      return;
    }
  ...
  console.log(chalk.green("\n🎉 Setup completed the installation!\n"));
})();
